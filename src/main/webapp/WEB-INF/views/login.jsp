...
<body class="">
					...
					<div class="col-sm-6">
						<form:form servletRelativeAction="login" method="post">
							<div class="form-checkout">
								<h5 class="form-title">JÁ SOU CADASTRADO</h5>
								<p>
								...
								<a class="newsletter-info" href="recupera">Esqueci a senha</a>
								</p>
								<input id="loginBtn" type="submit" class="button" name="login"
									value="ENTRAR">
							</div>
	...
	<!-- <script type="text/javascript">
		$(document).ready(function() {
			$('#novoCadastroBtn').click(function(event) {
				$.ajax({
					url : $("login").attr("action"),
					data : $("#NovoCadastro").serialize(),
					type : "POST",
					error : function(err) {
						console.log(err);
					},
					success : function(data) {
						console.log(data)
						$("#NovoCadastro").html($(data).find('#NovoCadastro').html());
					}
				});
